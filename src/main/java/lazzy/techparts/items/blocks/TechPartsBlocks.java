...
public class TechPartsBlocks {
    ...
    private static <T extends Block> RegistryObject<T> registerBasicBlock(String name, Supplier<T> block) {
    ...
    public static RegistryObject<MatPartBlock> registerMatPartBlock(Material mat, Parts part){
        RegistryObject<MatPartBlock> toReturn = BLOCKS.register(mat.getID()+"_"+part.getID(),()->new MatPartBlock(mat,part));
